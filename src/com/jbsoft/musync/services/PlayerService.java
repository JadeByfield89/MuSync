...
/* This Service will control all music playback
 * 
 */
                        ...
                        do {
                            ...
                            try {
                                ...
                                bitmap = BitmapFactory.decodeResource(getApplicationContext()
                                        .getResources(), R.drawable.genre_default);
                                mBitmaps.add(bitmap);
                            } catch (IOException e) {
                                e.printStackTrace();
                            }
